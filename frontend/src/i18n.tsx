...
const translations = {
  ...
  'map.weatherSubtitle': { en: 'Greater Jakarta (Jabodetabek) Precipitation Hazard Monitor', id: 'Monitor Bahaya Curah Hujan Jabodetabek' },
  ...
  'map.noHazards': { en: 'No active fleet assets detected inside heavy precipitation cells.', id: 'Tidak ada aset armada yang terdeteksi di dalam sel curah hujan lebat.' },
  'map.zone': { en: 'Zone:', id: 'Zona:' },
