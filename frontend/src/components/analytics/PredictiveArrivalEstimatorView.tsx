...
const SAMPLE_ROUTES: RoutePreset[] = [
  {
    id: 'rt_1',
    name: 'TNG HQ Depot ➡️ Tanjung Priok Cargo Gate 1',
    origin: 'Tangerang HQ Depot',
    destination: 'Tanjung Priok Container Gate 1',
    distanceKm: 64,
    baseSpeedKmh: 75,
  },
  {
    id: 'rt_2',
    name: 'CGK Cargo Hub ➡️ Bandung Int Airport (BDO)',
    origin: 'CGK Cargo Hub',
    destination: 'Bandung Airport Depot',
    distanceKm: 348,
    baseSpeedKmh: 85,
  },
  {
    id: 'rt_3',
    name: 'Cikupa Hub ➡️ BSD SkyPark (BSD)',
    origin: 'Cikupa Hub',
    destination: 'BSD Airport Depot',
    distanceKm: 28,
    baseSpeedKmh: 55,
  }
];
